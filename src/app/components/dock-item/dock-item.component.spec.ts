...
describe('DockItemComponent', () => {
  ...
  describe('DOM Rendering', () => {
    ...
    it('should conditionally render the active indicator', () => {
      ...
      fixture.detectChanges();
      expect(fixture.debugElement.query(By.css('.active-indicator'))).toBeTruthy();

      component.isActive = false;
      fixture.detectChanges();
      expect(fixture.debugElement.query(By.css('.active-indicator'))).toBeFalsy();
    });
    ...
    it('should set custom styles for width and scale', () => {
      ...
      const dockItemElement = fixture.debugElement.query(By.css('.dock-item')).nativeElement;
